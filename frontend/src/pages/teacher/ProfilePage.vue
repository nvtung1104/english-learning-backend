        ...
        <form @submit.prevent="handlePassword" class="theme-card rounded-[30px] p-6 space-y-5">
          ...
          <div class="form-group">
            ...
            <div class="relative">
              <input
                ...
                placeholder="••••••••"
              />
              <button type="button" class="pw-eye" @click="showPw.current = !showPw.current" tabindex="-1">
                {{ showPw.current ? '🙈' : '👁️' }}
              </button>
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="relative">
              ...
              />
              <button type="button" class="pw-eye" @click="showPw.new = !showPw.new" tabindex="-1">
                {{ showPw.new ? '🙈' : '👁️' }}
              </button>
            </div>
          ...
          <div class="form-group">
            ...
            <div class="relative">
              ...
              />
              <button type="button" class="pw-eye" @click="showPw.confirm = !showPw.confirm" tabindex="-1">
                {{ showPw.confirm ? '🙈' : '👁️' }}
              </button>
            </div>
            <p
